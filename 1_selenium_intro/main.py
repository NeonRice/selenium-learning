...
if __name__ == "__main__":
    ...
    try:
        ...
        # BY CSS ELEMENT
        heading = driver.find_element(by=By.CSS_SELECTOR, value="h1.jumbotron-heading")
        ...
        for card in cards:
            card_text = card.find_element(by=By.CLASS_NAME, value='card-text').text
            card.screenshot(os.path.join(os.getcwd(), card_text.replace(" ", "-")) + ".png")
